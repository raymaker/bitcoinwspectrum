Contributing to BWS Core
============================

The BWS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BWS Core project, and is not to be
confused with overall BWS Network Protocol consensus changes.

Whether a pull request is merged into BWS Core rests with the project merge
...
Patches that change BWS consensus rules are considerably more involved than
...
Where a patch set proposes to change the BWS consensus, it must have been
...
The project leader is the release manager for each BWS Core release.
