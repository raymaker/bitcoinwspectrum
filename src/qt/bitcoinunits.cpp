...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BWS:
            return QString("tBWS");
        case mBWS:
            return QString("mtBWS");
        case uBWS:
            return QString::fromUtf8("μtBWS");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BWS:
            return QString("BWS");
        case mBWS:
            return QString("Milli-BWS (1 / 1" THIN_SP_UTF8 "000)");
        case uBWS:
            return QString("Micro-BWS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BWS:
            return QString("TestBWSs");
        case mBWS:
            return QString("Milli-TestBWS (1 / 1" THIN_SP_UTF8 "000)");
        case uBWS:
            return QString("Micro-TestBWS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
