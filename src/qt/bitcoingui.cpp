                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BWS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BWS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bws: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBWS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BWS Core"), this);
    aboutAction->setStatusTip(tr("Show information about BWS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BWS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BWS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BWS addresses"));
    ...
    openAction->setStatusTip(tr("Open a BWS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BWS Core help message to get a list with possible BWS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BWS Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BWS Core"); // default title
