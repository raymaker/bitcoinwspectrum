                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BWS from zBWS"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBWS"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBWS));
