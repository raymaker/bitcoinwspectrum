...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BWS features */
        {"bws", "masternode", &masternode, true, true, false},
        {"bws", "listmasternodes", &listmasternodes, true, true, false},
        {"bws", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bws", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bws", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bws", "masternodedebug", &masternodedebug, true, true, false},
        {"bws", "startmasternode", &startmasternode, true, true, false},
        {"bws", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bws", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bws", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bws", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bws", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bws", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bws", "mnbudget", &mnbudget, true, true, false},
        {"bws", "preparebudget", &preparebudget, true, true, false},
        {"bws", "submitbudget", &submitbudget, true, true, false},
        {"bws", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bws", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bws", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bws", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bws", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bws", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bws", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bws", "checkbudgets", &checkbudgets, true, true, false},
        {"bws", "mnsync", &mnsync, true, true, false},
        {"bws", "spork", &spork, true, true, false},
        {"bws", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bws", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bwsd, or the -server option to bws-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bws-cli " + methodname + " " + args + "\n";
}
