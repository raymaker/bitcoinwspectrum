...
In order to support loading of multiple wallets in bws-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bws.cpp.
...
Changes to bws.cpp
----------------------
bws.cpp is the entry point into bws-qt, and as such, will require some minor modifications to provide hooks for
