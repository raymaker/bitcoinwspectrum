...
RESOURCES += src/qt/bws.qrc src/qt/bws_locale.qrc

TRANSLATIONS += src/qt/locale/bws_bg.ts \
                src/qt/locale/bws_de.ts \
                src/qt/locale/bws_en.ts \
                src/qt/locale/bws_es.ts \
                src/qt/locale/bws_fi.ts \
                src/qt/locale/bws_fr.ts \
                src/qt/locale/bws_it.ts \
                src/qt/locale/bws_ja.ts \
                src/qt/locale/bws_pl.ts \
                src/qt/locale/bws_pt.ts \
                src/qt/locale/bws_ru.ts \
                src/qt/locale/bws_sk.ts \
                src/qt/locale/bws_sv.ts \
                src/qt/locale/bws_vi.ts \
                src/qt/locale/bws_zh_CN.ts \
                src/qt/locale/bws_zh_TW.ts
